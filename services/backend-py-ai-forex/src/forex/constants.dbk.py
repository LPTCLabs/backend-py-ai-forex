MACRO_DATA: str = "src/data/macro_data-all_data_2.0.csv"
# NB_MACRO_DATA: int = 188  # 15, 188
TRAINING_WITH_TRAIN_DEV_DATA: bool = True
MODEL_PATH: str = "src/models/"
MACRO_DELAY_SOURCE: str = "src/data/delay_macro.csv"
TRAIN_DEV_DATA: str = "src/data/ML_Data_29un2022-train+dev.csv"
TRAIN_DATA: str = "src/data/ML_Data_29un2022-train.csv"
DEV_DATA: str = "src/data/ML_Data_29un2022-train.csv"
TEST_DATA: str = "src/data/ML_Data_29un2022-test.csv"
MODEL_TYPE = "logistic"  # SVM, logistic, RF, DecisionTree, XGBoost
...
WINDOW_PROBABILITY_ANALYSIS_NUMBER: int = 3  # 3 months rolling
